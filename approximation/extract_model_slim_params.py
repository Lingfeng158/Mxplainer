...
import json
from model_slim import MahJongNetBatchedRevised as model
...
if __name__ == "__main__":
    ...
    for weight in weight_list:
        ...
        fan_coeff, tile_coeff = net.access_named_params()
        fan_dict = reversed_tile_conversion(fan_coeff, fan_list_raw)
