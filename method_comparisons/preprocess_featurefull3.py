from MahJong_feature_agent2_adapted2 import FeatureAgent2Adapted2 as FeatureAgent
import numpy as np
import json
import os
...
def saveData(sl_data_path, obs, actions, mark, matchid, augment_factor=8):
    ...
    sl_true_data_path = os.path.join(sl_data_path, "sl_data_featurefull3/")
    sl_meta_data_path = os.path.join(sl_data_path, "sl_meta_featurefull3/")
...
if __name__ == "__main__":
    ...
    split_data_path = "../data/test/split_data/"
    sl_data_path = "../data/test/"
    ...
    with open(os.path.join(sl_data_path, "count_featurefull3.json"), "w") as f:
