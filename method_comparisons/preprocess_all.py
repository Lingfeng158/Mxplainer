from MahJong_search_agent_slim import SearchAgentSlim as FeatureAgent
import numpy as np
import json
import os
from multiprocessing import Pool

# Compared to preprocess.py, preprocess_all.py includes all data points, including those with only one valid actions
...
def saveData(sl_data_path, obs, actions, mark, matchid, augment_factor=8):
    ...
    sl_true_data_path = os.path.join(sl_data_path, "sl_data_all/")
    sl_meta_data_path = os.path.join(sl_data_path, "sl_meta_all/")
...
if __name__ == "__main__":
    ...
    split_data_path = "../data/smth/split_data/"
    sl_data_path = "../data/smth/"
    ...
    with open(os.path.join(sl_data_path, "count_all.json"), "w") as f:
