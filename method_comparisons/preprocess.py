from MahJong_search_agent_slim2 import SearchAgentSlim2 as FeatureAgent
import numpy as np
import json
import os
...
def saveData(sl_data_path, obs, actions, mark, matchid, augment_factor=8):
    ...
    sl_true_data_path = os.path.join(sl_data_path, "sl_dataV2/")
    sl_meta_data_path = os.path.join(sl_data_path, "sl_metaV2/")
...
if __name__ == "__main__":
    ...
    # pool.close()
    # pool.join()
    preprocess(split_data_path, sl_data_path, 83781, 0, augmentation_times)
    sl_meta_data_path = os.path.join(sl_data_path, "sl_metaV2/")
    ...
    with open(os.path.join(sl_data_path, "countV2.json"), "w") as f:
