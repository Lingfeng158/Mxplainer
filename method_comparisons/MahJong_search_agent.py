...
if platform.python_version()[:3] == "3.6":
    ...
    from fanCalcLibPy39 import formMinComb_c
...
class SearchAgent(MahjongGBAgent):
    """
    observation: 76*4*9
    ...
    def expose(self):
        print("Seatwind: {}".format(self.seatWind))
        print("Hand:{}".format(self.hand))
        print("All Packs:{}".format(self.packs))
        print("TileWall:{}".format(self.tileWall))
        print("ShownTiles:{}".format(self.shownTiles))
        print("KnownTiles:{}".format(self.knownTiles))
        tilewall = defaultdict(int)
        for t in self.knownTiles:
            tilewall[t] = 4 - self.knownTiles[t]
        print("Tile Wall:{}".format(tilewall))
        print("Search Redundant: {}".format(self.search_redundant[0]))
        print("Search Missing: {}".format(self.search_missing[0]))
        print(self.obs[self.OFFSET_OBS["MELD"] : self.OFFSET_OBS["MELD"] + 8])
