...
# 1. fixed crash when search-result list is empty (Done)
# 2. memorized other's play history and pack info
# 3. is able to load parameter from supervised_learning_v2 model

# In DEVELOPMENT, pending feature #2, #3

# PLANNED:
# Bot v3:
# Based on v2, this bot:
# 1. deal with 全求人, with additional search on 2-fan targets
# 2. modified search-result logic accomodating 全求人
# 3. is able to load parameter from supervised_learning_v3 model
